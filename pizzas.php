...
<body>
    ...
    <main>
        <h1 id="pizzas">Nossas Pizzas</h1>
        <div id="galeria2">

             <?php

            $sql = "select nomeproduto,valor,tipo,cupom,imagem from produto where tipo=1";
            ...
            ?> 
                    ...
                    <div class="gallery">
                        <a href="#">
                            <img src="<?=$linha['imagem']?>" alt="Produtos" width="600" height="200">
                        </a>
